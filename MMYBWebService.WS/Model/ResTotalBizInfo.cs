...
namespace MMYBWebService.WS.Model
{
    public class ResTotalBizInfo
    {
        ...
        public string diag_item_year { get; set; }
        public string month_diag_year { get; set; }
        public string month_lx { get; set; }
        public string corp_add_year { get; set; }
